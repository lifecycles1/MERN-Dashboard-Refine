...
function App() {
  const authProvider: AuthProvider = {
    login: async ({ credential }: CredentialResponse) => {
      ...
      if (profileObj) {
        const response = await fetch("https://refine-dashboard-53u9.onrender.com/api/v1/users", {
          method: "POST",
  ...
  return (
    <ColorModeContextProvider>
      ...
      <RefineSnackbarProvider>
        <Refine
          dataProvider={dataProvider("https://refine-dashboard-53u9.onrender.com/api/v1")}
